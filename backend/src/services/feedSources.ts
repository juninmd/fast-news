 ...
 *
 * Kept dependency-free (no config, no database) so tooling — the homologation
 * harness in particular — can enumerate the providers without a live backend.
 */
...
export const RETIRED_FEED_URLS = [
