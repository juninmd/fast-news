    ...
    default: ({ isOpen, onClose, onSave }) => (
        isOpen ? (
            <div data-testid="settings-modal">
                Settings Modal
                <button onClick={() => { onSave({ aiSdkApiKey: 'new-sdk-key', aiSdkProvider: 'openai' }); onClose(); }}>Save</button>
...
describe('App', () => {
    ...
    it('updates api key and closes modal on save', async () => {
        ...
        expect(screen.getByTestId('feed')).toHaveTextContent('Feed Component (Provider: openai, Key: new-sdk-key)');
