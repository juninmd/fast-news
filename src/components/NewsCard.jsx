...
const NewsCard = React.memo(
	({ item, aiProvider, apiKey, aiModel, autoSummarize }) => {
		...
		}, [isVisible, autoSummarize, summary, loading, error, handleSummarize]);
		...
		return (
			<div
				ref={cardRef}
				className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-sm hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_20px_50px_rgba(0,0,0,0.4)] hover:-translate-y-2 transition-all duration-500 h-full flex flex-col overflow-hidden group border border-slate-200/50 dark:border-slate-800/80"
			>
				<div className="p-3">
					...
					<div className="relative overflow-hidden rounded-[1.5rem]">
						{video ? (
							...
							<div className="aspect-[4/3] bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 flex items-center justify-center relative">
				...
				<div className="px-5 pb-5 mt-auto bg-slate-50/50 dark:bg-slate-900/50">
					<div className="flex items-center justify-between py-2.5 border-b border-slate-200/50 dark:border-slate-700/50">
						...
						<div className="flex items-center gap-1">
							...
							<button
								...
								className="p-2 rounded-lg text-slate-400 dark:text-slate-500 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all"
								title="Copiar link"
							>
					...
					<div className="flex gap-2 mt-3">
						<button
							...
							className="flex items-center justify-center gap-2 flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-3 rounded-2xl text-sm font-bold transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-50"
						>
							{sendingTelegram ? (
								<Loader size={16} className="animate-spin" />
